...
export const environment = {
  ...
  mainEnumStatus : [{ 'lb': 'New', 'val': 'open', 'index': 0 }, { 'lb': 'History', 'val': 'booked', 'index': 1 }],
  tripEnumStatus : [
    // tslint:disable-next-line: object-literal-key-quotes
    { 'lb': 'Booked', 'val': 'booked', 'index': 1 },{ 'lb': 'Cancellation Pending', 'val': 'cancellation request', 'index': 3 },
    // tslint:disable-next-line: object-literal-key-quotes
    { 'lb': 'Cancelled', 'val': 'cancelled', 'index': 4 }, { 'lb': 'Reschedule Pending', 'val': 'reschedule_request', 'index': 5 },
    // tslint:disable-next-line: object-literal-key-quotes
  ...
  // tslint:disable-next-line: object-literal-key-quotes
  filterBy : { 'start_date': '', 'end_date': '', 'id': '', 'limit': '', 'booking_mode': '' },
  portal_version : 'V2',
  baseUrlMode : 'DEV'
};
